...
export const getGenres = createAsyncThunk("netflix/genres", async () => {
  const {
    ...
    "https://api.themoviedb.org/3/genre/movie/list?api_key=6668b1c96540af59cdaa98a7c7509233"
  );
...
export const fetchDataByGenre = createAsyncThunk(
  ...
  async ({ genre, type }, thunkAPI) => {
    ...
    return getRawData(
      `https://api.themoviedb.org/3/discover/${type}?api_key=6668b1c96540af59cdaa98a7c7509233&with_genres=${genre}`,
      genres
    );
  }
);
...
export const { setGenres, setMovies, setLogin, setLogout } =
